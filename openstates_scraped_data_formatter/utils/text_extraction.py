...
def process_bills_in_batch(processed_folder: Path, batch_size: int = 100) -> Dict[str, int]:
    """
    ...
    for i in range(0, total_bills, batch_size):
        ...
        print(f"✅ Batch {batch_num} complete. Success: {success_count}, Errors: {error_count}")
